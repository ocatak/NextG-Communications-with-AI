...
# Generate adversarial examples using MIM
epsilon = 0.1
...
#plt.savefig("../../../Module-2-AML_files/Module-2-AML_15_0.pdf",bbox_inches='tight')
...
#plt.savefig("../../../Module-2-AML_files/Module-2-AML_15_1.pdf",bbox_inches='tight')
